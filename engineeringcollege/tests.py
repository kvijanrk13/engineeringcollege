...
class MoocsPageTests(TestCase):
    ...
    def test_moocs_exam_console_renders(self):
        ...
        self.assertContains(response, "One hundred mixed, syllabus-aligned papers")
        self.assertContains(response, "set <= 100")
        ...
        self.assertContains(response, "/static/moocs/moocs.js?v=43")
