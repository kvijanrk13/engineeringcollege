...
urlpatterns = [
    ...
    path('parents/', views.parent_contact_list, name='parent_contact_list'),
    path('parents/add/', views.parent_contact_create, name='parent_contact_create'),
    ...
    path('attendance/absent-parent-alerts/', views.parent_absence_notifications, name='parent_absence_notifications'),
    path('parent-notifications/', views.parent_notification_logs, name='parent_notification_logs'),
    path('parent-notifications/<int:pk>/send/', views.parent_notification_send, name='parent_notification_send'),
    path('parent-notifications/<int:pk>/acknowledge/', views.parent_acknowledge, name='parent_acknowledge'),
