...
function answerExplanation(q,answer){
  ...
  if(isCorrect(q,answer))return `The selected option, “${selected},” is correct. ${reason}`;
  if(answer===null||answer===undefined||answer==='')return `The correct option is “${correct}.” ${reason}`;
  return `The selected option, “${selected},” is not correct for this question. The correct option is “${correct}.” ${reason}`;
}
