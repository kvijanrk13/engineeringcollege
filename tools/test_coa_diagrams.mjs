...
for (const hook of ['coa-diagram-library','coa-diagram-search','coa-chapter-filters','coa-diagram-grid','coa-diagram-lightbox','showModal()','workingSteps','coa-animation-play','coa-animation-step-previous','coa-animation-step-next','coa-card-steps','coa-card-step-status','coa-redraw-canvas','prepareRedraw','drawStage','activeCardStop','coa-card-io','coa-card-io-input','runCardSimulator','interactive-io-2','coa-io-input','coa-io-process','coa-io-output','simulateFigure','runSimulator','prefers-reduced-motion','ArrowLeft','ArrowRight','PageUp','PageDown']) assert.ok(template.includes(hook), `template missing ${hook}`);
