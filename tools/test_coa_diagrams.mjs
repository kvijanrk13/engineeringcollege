...
for (const hook of ['coa-diagram-library','coa-diagram-search','coa-chapter-filters','coa-diagram-grid','coa-diagram-lightbox','showModal()','workingSteps','coa-animation-play','coa-animation-step-previous','coa-animation-step-next','prefers-reduced-motion','ArrowLeft','ArrowRight','PageUp','PageDown']) assert.ok(template.includes(hook), `template missing ${hook}`);
